                ...
                while (i==true)
                {
                    ...
                    switch (str)
                    {
                        ...
                        case "getallusers":
                                ...
                                break;
                        case "setpwd":
                                WebSocketLoader.setuserinfo(WebSocketLoader.g_now_sn, 1, "AAAA", 10, 0, 123456, null);
                                break;
                        case "setcard":
                        ...
                        case "adduser":
                            ...
                            WebSocketLoader.adduser(WebSocketLoader.g_now_sn,888,50,0,"test");
                            break;                        
                      
						case "setprofile":
							WebSocketLoader.setuserprofile(WebSocketLoader.g_now_sn,1,"1,3,5"); //can use \\n to wrap max is 4096,but display is 110
							break;
						case "getprofile":
							WebSocketLoader.getuserprofile(WebSocketLoader.g_now_sn,1); //0 is notice >0 is the users
							break;
                        ////////////////////////////////////////////for debug
                        case "uploadalluser":

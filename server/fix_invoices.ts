...
import { getDb, ensureAdminInitialized } from "./firebaseAdmin.js";
  ...
  try {
    ...
    for (const doc of invoicesSnap.docs) {
      ...
      if (
        ...
        if (!desc.includes("(مع:")) {
          console.log(`Checking invoice ${doc.id}: ${desc}`);
          ...
          if (createdAt) {
             ...
             if (partnerName) {
                ...
                // update local log description if audit log exists with same timestamp
